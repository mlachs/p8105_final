...
visitation_data %>% 
  ...
  arrange(desc(parks))  %>%  knitr::kable()
```
...
northeast_plot <- region_data %>%
  ...
  labs(title = "Visitation in Northeastern Region of U.S. by Season", 
       x = "Season", 
...
midwest_plot <- 
  ...
  geom_col() +  
  facet_grid(~type_visit) + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1)) + 
  labs(title = "Visitation in Midwestern Region of U.S. by Season", 
       x = "Season", 
       y = "Average Visitation")
```
...
south_plot <- 
  ...
  geom_col() +  
  facet_grid(~type_visit) + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1)) + 
  labs(title = "Visitation in Southern Region of U.S. by Season", 
       x = "Season", 
       y = "Average Visitation")
```
...
west_plot <- 
  ...
  geom_col() +  
  facet_grid(~type_visit) + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1)) + 
  labs(title = "Visitation in Western Region of U.S. by Season", 
       x = "Season", 
       y = "Average Visitation") 
